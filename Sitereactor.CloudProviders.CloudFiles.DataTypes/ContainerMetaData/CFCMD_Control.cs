...
{
    public class CFCMD_Control : PlaceHolder
    {
        /// <summary>
        /// Gets or sets the options.
        /// </summary>
        /// <value>The options for the control.</value>
        public CFCMD_Options Options { get; set; }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            this.ContainerInputBox.ReadOnly = true;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if (!string.IsNullOrEmpty(ContainerInputBox.Text))
